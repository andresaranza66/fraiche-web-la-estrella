...
export default function UnisexPage ()  {
  ...
  const perfumes = useQuery(api.perfumes.listByGender, { gender: "unisex" });
          ...
          <div className="grid grid-cols-1 gap-10 rounded-2xl border border-[color:var(--color-neutral-200)] bg-white p-10 md:grid-cols-2 mt-5">
            ...
            <div className="flex items-center justify-center bg-orange-200 rounded-2xl p-5 gap-5">
              <div className="relative h-[260px] w-full max-w-[250px]">
                <Image src="/images/dreamer.png" alt="Hombres" fill className="object-contain" priority />
              </div>
              <div className="relative h-[260px] w-full max-w-[250px]">
                <Image src="/images/strong.png" alt="Hombres" fill className="object-contain" priority />
              </div>
            </div>
          </div>
